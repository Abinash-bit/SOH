(window.webpackJsonp_ember_auto_import_=window.webpackJsonp_ember_auto_import_||[]).push([[0],{760:function(t,e,r){"use strict"
r.d(e,"a",(function(){return l})),r.d(e,"b",(function(){return s}))

// Get the grid of the terrain
...
return"ltr"!==u&&"rtl"!==u&&(u=!0===a?"rtl":"ltr"),{strings:l,direction:u}}},761:function(t,e,r){"use strict"
r.d(e,"a",(function(){return fe}))
var n=r(260),i=r(760),o=function(t,e){return(o=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,e){t.__proto__=e}||function(t,e){for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&(t[r]=e[r])})(t,e)}
...
//Fetch Property adress with latitudes and longitudes
...
// JSON data is saved into cordinates like 1,5 1,6 1,4
...
// Apart from that time domain is not accepted
...
// Time zone is fetched From JSON
...
//It is used to make smooth partitions of unity
...
//Back tracking is done from the JSON Dataset and the Data is analysed by Keras , API for Deeep Learning.
...
//Progress Bar is set with year month timezone 5 months 7 days 1 day
...
//trackbar is updated with analysed Data
